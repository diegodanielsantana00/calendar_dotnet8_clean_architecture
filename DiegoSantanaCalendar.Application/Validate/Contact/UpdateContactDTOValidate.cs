...
{
    public class UpdateContactDTOValidate : AbstractValidator<UpdateContactDTO>
    {
        public UpdateContactDTOValidate()
        {
            RuleFor(c => c.Id)
                .NotEmpty().WithMessage("O Id do contato é obrigatório para a atualização.");
